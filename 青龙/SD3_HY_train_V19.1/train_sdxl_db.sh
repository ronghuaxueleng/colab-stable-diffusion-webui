...
# Train Model | 训练模式
model="sdxl_db" #lora、db、sdxl_lora、sdxl_db、sdxl_cn3l、contralnet、stable_cascade_db、stable_cascade_lora、hunyuan_lora、hunyuan_db、sd3_db
...
output_name="sdxl_db"  # output model name | 模型保存名称
