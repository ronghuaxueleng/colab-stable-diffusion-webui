...
$pretrained_model = "./HunYuanDiT_fp16" # base model path | 底模路径
...
$lr_decay_steps = 5000 # decay steps | 学习率衰减步数，仅在 lr_scheduler 为warmup_stable_decay时 需要填写，一般是10%总步数
...
#gorkfast | 快速拟合
$gradfilter_ema_alpha=0.98 #EMA的动量超参数 设置ema_alpha来激活gradfilter_ema，推荐0.98，为0则关闭
...
$sample_prompts = "./toml/controlnet.txt" #prompt文件路径
...
$controlnet_model_name_or_path= "./ControlNet/sdxl/xinsir_controlnet-openpose-sdxl-v2.safetensors"
$conditioning_data_dir = "./train/dsine/0414-dwpose"
$cond_emb_dim = 32
